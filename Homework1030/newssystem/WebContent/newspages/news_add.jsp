    ...
    <h1 id="opt_type">
     ...
     <c:choose>
     	<c:when test="${param.opr eq 'update' }"> <!-- 编辑新闻 -->
		     ...
		     <form action="../util/news_control?opr=addNews&news=update&nid=${news.nid}" method="post">
			      <p>
			        <label> 主题 </label>
       ...
       <form action="../util/news_control?opr=addNews&news=add" enctype="form-data" method="post">
      <p>
        <label> 主题 </label>
