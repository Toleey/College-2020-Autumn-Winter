...
public interface ProviderMapper {
    ...
    //查询供应商通过好多信息
    public List<Provider> findProviderByProCodeAndProNameAndProContactAndCreationDate(Map<String,Object> providerMap) throws  Exception;
}
