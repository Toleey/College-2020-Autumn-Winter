...
//                session.getMapper(OrderDetailDao.class).add(orderDetail); // 更新商品表的库存
//                session.getMapper(ProductDao.class).updateStock(
...
//                order.setOrderDetailList(session.getMapper(OrderDetailDao.class).getOrderDetailList(order.getId()));
//                for (OrderDetail item : order.getOrderDetailList()) {
//                    item.setProduct(session.getMapper(ProductDao.class).getProductById(item.getProductId()));
//                }
//            }
//        } catch (Exception e) {
//            e.printStackTrace();
