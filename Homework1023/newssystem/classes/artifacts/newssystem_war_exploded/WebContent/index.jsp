...
<div id="header">
  <div id="top_login">
    <form action="util/do_login.jsp?opr=index" method="post" onsubmit="return check()">
      <label> 登录名 </label>
    ...
    <div class="content">
      <ul class="class_date">
       <!--  <li id='class_month'> <a href='#'><b> 国内 </b></a> <a href='#'><b> 国际 </b></a> <a href='#'><b> 军事 </b></a> <a href='#'><b> 体育 </b></a> <a href='#'><b> 娱乐 </b></a> <a href='#'><b> 社会 </b></a> <a href='#'><b> 财经 </b></a> <a href='#'><b> 科技 </b></a> <a href='#'><b> 健康 </b></a> <a href='#'><b> 汽车 </b></a> <a href='#'><b> 教育 </b></a> </li>
        ...
        <li id='class_month'>      
        	...
        	<a href='util/news_control.jsp?ntid=<%=topicList.get(i).getTid()%>&opr=topicNews'><b> <%=topicList.get(i).getTname() %> </b></a>
      ...
      <ul class="classlist">
      	...
      	%>
       	...
       	<li><a href='util/news_control.jsp?opr=readNews&nid=<%= news.getNid() %>'> <%=news.getNtitle() %> </a><span> <%=news.getNcreateDate() %> </span></li>
       ...
       <%-- 	<%	//默认新闻
      	...
      	%>
       	...
       	<li><a href='util/news_control.jsp?opr=readNews&nid=<%= allNewsPageList.getNid() %> '> <%=allNewsPageList.getNtitle() %> </a><span> <%=allNewsPageList.getNcreateDate() %> </span></li>
       ...
       <%-- 	 <p align="right">
       	...
       	%>	
			...
			%>   
			  <a href="util/news_control.jsp?pageIndex2=1&opr=topicNews&ntid=<%=ntid%>">首页</a>
      	   	  <a href="util/news_control.jsp?pageIndex2=<%=pageIndex2 - 1%>&opr=topicNews&ntid=<%=ntid%>">上一页</a>
			<%
			} if (pageIndex2 < pageCount2) { // 控制页面显示风格
			%>
			   <a href="util/news_control.jsp?pageIndex2=<%=pageIndex2 + 1%>&opr=topicNews&ntid=<%=ntid%>">下一页</a>
      	       <a href="util/news_control.jsp?pageIndex2=<%=pageCount2 %>&opr=topicNews&ntid=<%=ntid%>">末页</a>
			<%   
			} }
			%>   
