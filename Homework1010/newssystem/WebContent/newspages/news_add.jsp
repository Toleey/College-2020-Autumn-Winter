...
<div id="main">
  ...
  <div id="opt_area">
    ...
    %>
        <form action="../util/news_control.jsp?opr=addNews&news=update&nid=<%=news.getNid() %>" method="post">
      <p>
        <label> 主题 </label>
        <select name="ntid">
      ...
      <%}else{ 
    	//添加新闻
      %>
       <form action="../util/news_control.jsp?opr=addNews&news=add" method="post">
      <p>
        <label> 主题 </label>
        <select name="ntid">
          <option value="1">选择</option>
