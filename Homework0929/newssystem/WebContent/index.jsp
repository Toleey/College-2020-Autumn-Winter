    ...
    <div class="content">
      ...
      <ul class="classlist">
      	...
      	%>
       	...
       	<li><a href='#'> <%=news.getNtitle() %> </a><span> <%=news.getNcreateDate() %> </span></li>
       	<li><a href='#newspages/news_read.jsp'> </a><span> </span></li>
      	...
      	%>
       	...
       	<li><a href='#'> <%=deafultNews.getNtitle() %> </a><span> <%=deafultNews.getNcreateDate() %> </span></li>
       	<li><a href='#newspages/news_read.jsp'> </a><span> </span></li>
